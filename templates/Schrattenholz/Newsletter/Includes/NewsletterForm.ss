<h3 class="widget-title pb-1 text-light">Wir informieren gerne</h3>
<form id="Form_AnmeldeformularNewsletter" class="needs-validation" novalidate>
	...
	<small class="form-text text-white opacity-50" id="mc-helper">*Sie erhalten eine Bestätigungs-Mail, mit der Sie das Newsletter-Abonnement bestätigen müssen.</small>
